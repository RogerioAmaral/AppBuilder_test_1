...
$rootScope.App.ID = "com.sistemaaula.appbt1";
$rootScope.App.Name = "AppBuilderTest1";
$rootScope.App.ShortName = "App Builder Test 1";
$rootScope.App.Version = "1.0.0";
$rootScope.App.Description = "App Builder Test 1";
$rootScope.App.AuthorName = "Rogerio Amaral";
$rootScope.App.AuthorEmail = "rogerio@sistemaaula.com.br";
$rootScope.App.AuthorUrl = "https://www.sistemaaula.com.br";
...
window.App.Debugger.log("Começar de Evento Ready do aplicativo", "info", -1);

window.App.Debugger.log("ArrayClear \x22[Navbar1.Items]\x22", "info", 1);

$rootScope.Navbar1.Items = [];

window.App.Debugger.log("ArrayClear \x22[Navbar2.Items]\x22", "info", 2);
...
window.App.Debugger.log("CopyVar \x22[Navbar2.Items]\x22 \x22[Navbar1.Items]\x22", "info", 25);

$rootScope.Navbar2.Items = $rootScope.Navbar1.Items;

window.App.Debugger.log("Fim de Evento Ready do aplicativo", "info", -2);
...
window.App.Debugger.log("Começar de Navbar1 Item click event", "info", -1);

window.App.Debugger.log("AlertBox \x22You press the [Navbar1.Item.Text] item!\x22 \x22[Navbar1.Kind]\x22", "info", 1);

$scope.alertBox("You press the "+$rootScope.Navbar1.Item.Text+" item!", $rootScope.Navbar1.Kind);

window.App.Debugger.log("Fim de Navbar1 Item click event", "info", -2);

};

$rootScope.Navbar1.BrandClick = function($event) {
  $rootScope.Navbar1.Event = $event;
window.App.Debugger.log("Começar de Navbar1 Brand click event", "info", -1);

window.App.Debugger.log("AlertBox \x22You press the Navbar Brand!\x22 \x22[Navbar1.Kind]\x22", "info", 1);

$scope.alertBox("You press the Navbar Brand!", $rootScope.Navbar1.Kind);

window.App.Debugger.log("Fim de Navbar1 Brand click event", "info", -2);
...
window.App.Debugger.log("Começar de KindSelect Change event", "info", -1);

window.App.Debugger.log("ArrayGetItem \x22[KindSelect.Items]\x22 \x22[KindSelect.ItemIndex]\x22 \x22[Navbar1.Kind]\x22", "info", 1);

$rootScope.Navbar1.Kind = $rootScope.KindSelect.Items[$rootScope.KindSelect.ItemIndex];

window.App.Debugger.log("ArrayGetItem \x22[KindSelect.Items]\x22 \x22[KindSelect.ItemIndex]\x22 \x22[Navbar2.Kind]\x22", "info", 2);

$rootScope.Navbar2.Kind = $rootScope.KindSelect.Items[$rootScope.KindSelect.ItemIndex];

window.App.Debugger.log("Fim de KindSelect Change event", "info", -2);

};
$rootScope.Navbar2.ItemClick = function($event, item) {
  $rootScope.Navbar2.Event = $event;
  $rootScope.Navbar2.Item = item;
window.App.Debugger.log("Começar de Navbar2 Item click event", "info", -1);

window.App.Debugger.log("AlertBox \x22You press the [Navbar2.Item.Text] item!\x22 \x22[Navbar2.Kind]\x22", "info", 1);

$scope.alertBox("You press the "+$rootScope.Navbar2.Item.Text+" item!", $rootScope.Navbar2.Kind);

window.App.Debugger.log("Fim de Navbar2 Item click event", "info", -2);

};

$rootScope.Navbar2.BrandClick = function($event) {
  $rootScope.Navbar2.Event = $event;
window.App.Debugger.log("Começar de Navbar2 Brand click event", "info", -1);

window.App.Debugger.log("AlertBox \x22You press the Navbar Brand!\x22 \x22[Navbar1.Kind]\x22", "info", 1);

$scope.alertBox("You press the Navbar Brand!", $rootScope.Navbar1.Kind);

window.App.Debugger.log("Fim de Navbar2 Brand click event", "info", -2);
